...
public class Launcher2
{
    ...
    private static final String WEBROOT_INDEX = "/classes";
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        Launcher2 main = new Launcher2(port);
        main.start();
        main.waitForInterrupt();
    }

    private static final Logger LOG = Logger.getLogger(Launcher2.class.getName());

    private int port;
    private Server server;

    public Launcher2(int port)
    {
        this.port = port;
    }
    ...
    public void start() throws Exception
    {
        ...
        holderAltMapping.setForcedPath("/welcome.jsp");
        servletContextHandler.addServlet(holderAltMapping, "/welcome/");
