...
public abstract class AbstractNettyHttp2Handler extends Http2ConnectionHandler {
	 private static long GRACEFUL_SHUTDOWN_TIMEOUT = SECONDS.toMillis(5);
	  ...
	  AbstractNettyHttp2Handler(Http2ConnectionDecoder decoder,
	  ...
	  public ChannelFuture goAway(ChannelHandlerContext ctx,
              int lastStreamId,
              long errorCode,
              ByteBuf debugData,
